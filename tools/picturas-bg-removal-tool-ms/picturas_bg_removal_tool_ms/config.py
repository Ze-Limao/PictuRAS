...
RABBITMQ_REQUESTS_QUEUE_NAME = os.getenv("RABBITMQ_REQUESTS_QUEUE_NAME", "bg-removal-requests")
...
PICTURAS_MS_NAME = os.getenv("PICTURAS_MS_NAME", "picturas-bg-removal-tool-ms")
