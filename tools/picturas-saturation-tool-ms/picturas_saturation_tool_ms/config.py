...
RABBITMQ_REQUESTS_QUEUE_NAME = os.getenv("RABBITMQ_REQUESTS_QUEUE_NAME", "saturation-requests")
...
PICTURAS_MS_NAME = os.getenv("PICTURAS_MS_NAME", "picturas-saturation-tool-ms")
